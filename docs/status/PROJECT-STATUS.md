...
- 개선 후보(비긴급): 운영 첫 방문 시 텍스처 로딩 수 초간 검정 → hex 단색 폴백 표시
...
- 다음 액션: ① 씬 P-A(재질·빛) 착수 — SCENE-PLAN 참조 ② 킬-실험 2 결과 수령 → 품질 상향 우선순위 ③ 손잡이 실물 사진(무배경) 수령 시 P-D 정밀화 ④ 문다온 확인 3건(시트코드 S127/S128·겹침폭·스윙 유리 5종 명단)
